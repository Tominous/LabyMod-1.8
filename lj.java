    ...
    throws Exception
  {
    ...
    try
    {
      ...
      case 0: 
        ...
        String ☃ = String.format("%s§%d§%d", new Object[] { ☃.am(), Integer.valueOf(☃.I()), Integer.valueOf(☃.J()) });
        a(☃, a(☃));
      ...
      case 1: 
        ...
        String ☃ = String.format("§1\000%d\000%s\000%s\000%d\000%d", new Object[] { Integer.valueOf(127), ☃.H(), ☃.am(), Integer.valueOf(☃.I()), Integer.valueOf(☃.J()) });
        a(☃, a(☃));
