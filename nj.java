...
public class nj
{
  ...
  private static String a(URL ☃, String ☃, boolean ☃)
  {
    try
    {
      Proxy ☃ = MinecraftServer.N() == null ? null : MinecraftServer.N().ay();
      if (☃ == null) {
        ☃ = Proxy.NO_PROXY;
      }
  ...
  public static ListenableFuture<Object> a(final File ☃, final String ☃, final Map<String, String> ☃, final int ☃, nu ☃, final Proxy ☃)
  {
      ...
      public void run()
      {
        ...
        try
        {
          ...
          if (☃.exists())
          {
            ...
            nj.b().warn("Deleting " + ☃ + " as it does not match what we currently have (" + ☃ + " vs our " + ☃ + ").");
