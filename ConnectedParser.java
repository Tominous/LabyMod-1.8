...
public class ConnectedParser
{
  ...
  public MatchBlock[] parseMatchBlock(String blockStr)
  {
    ...
    afh[] blocks = parseBlockPart(domain, blockPart);
    if (blocks == null) {
      return null;
    }
    ...
    for (int i = 0; i < blocks.length; i++)
    {
      ...
      int[] metadatas = parseBlockMetadatas(block, params);
  ...
  public ady[] parseBiomes(String str)
  {
    ...
    ady[] biomeArr = (ady[])list.toArray(new ady[list.size()]);
    return biomeArr;
  }
