...
public class PlayerItemParser
{
  ...
  private static bct parseModelRenderer(JsonObject elem, bbo modelBase)
  {
    ...
    if (submodel != null)
    {
      bct subMr = parseModelRenderer(submodel, modelBase);
      mr.a(subMr);
    }
    ...
    if (submodels != null) {
      for (int i = 0; i < submodels.size(); i++)
      {
        ...
        bct subMr = parseModelRenderer(sm, modelBase);
        mr.a(subMr);
      }
    }
    return mr;
