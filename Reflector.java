...
public class Reflector
{
  ...
  public static ReflectorMethod ForgeWorld_countEntities = new ReflectorMethod(ForgeWorld, "countEntities", new Class[] { pt.class, Boolean.TYPE });
  ...
  public static ReflectorConstructor DrawScreenEvent_Pre_Constructor = new ReflectorConstructor(DrawScreenEvent_Pre, new Class[] { axu.class, Integer.TYPE, Integer.TYPE, Float.TYPE });
  ...
  public static ReflectorConstructor DrawScreenEvent_Post_Constructor = new ReflectorConstructor(DrawScreenEvent_Post, new Class[] { axu.class, Integer.TYPE, Integer.TYPE, Float.TYPE });
  ...
  public static ReflectorConstructor EntityViewRenderEvent_FogColors_Constructor = new ReflectorConstructor(EntityViewRenderEvent_FogColors, new Class[] { bfk.class, pk.class, afh.class, Double.TYPE, Float.TYPE, Float.TYPE, Float.TYPE });
  ...
  public static ReflectorConstructor EntityViewRenderEvent_FogDensity_Constructor = new ReflectorConstructor(EntityViewRenderEvent_FogDensity, new Class[] { bfk.class, pk.class, afh.class, Double.TYPE, Float.TYPE });
  ...
  public static ReflectorConstructor EntityViewRenderEvent_RenderFogEvent_Constructor = new ReflectorConstructor(EntityViewRenderEvent_RenderFogEvent, new Class[] { bfk.class, pk.class, afh.class, Double.TYPE, Integer.TYPE, Float.TYPE });
  ...
  public static ReflectorConstructor RenderLivingEvent_Pre_Constructor = new ReflectorConstructor(RenderLivingEvent_Pre, new Class[] { pr.class, bjl.class, Double.TYPE, Double.TYPE, Double.TYPE });
  ...
  public static ReflectorConstructor RenderLivingEvent_Post_Constructor = new ReflectorConstructor(RenderLivingEvent_Post, new Class[] { pr.class, bjl.class, Double.TYPE, Double.TYPE, Double.TYPE });
  ...
  public static ReflectorConstructor RenderLivingEvent_Specials_Pre_Constructor = new ReflectorConstructor(RenderLivingEvent_Specials_Pre, new Class[] { pr.class, bjl.class, Double.TYPE, Double.TYPE, Double.TYPE });
  ...
  public static ReflectorConstructor RenderLivingEvent_Specials_Post_Constructor = new ReflectorConstructor(RenderLivingEvent_Specials_Post, new Class[] { pr.class, bjl.class, Double.TYPE, Double.TYPE, Double.TYPE });
  ...
  public static ReflectorClass ForgeItemRecord = new ReflectorClass(aak.class);
  ...
  public static ReflectorClass ForgeVertexFormatElementEnumUseage = new ReflectorClass(bmv.b.class);
