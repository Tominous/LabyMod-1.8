  ...
  extends bbo
{
  ...
  public void a(pr ☃, float ☃, float ☃, float ☃)
  {
    ...
    this.a.f = (☃ * (0.2617994F + ☃) + ☃ * 2.18166F + (1.0F - Math.max(☃, ☃)) * this.a.f);
    this.a.g = (☃ * ☃ / 57.295776F + (1.0F - Math.max(☃, ☃)) * this.a.g);
    
    this.a.d = (☃ * -6.0F + ☃ * 11.0F + (1.0F - Math.max(☃, ☃)) * this.a.d);
    this.a.e = (☃ * -1.0F + ☃ * -10.0F + (1.0F - Math.max(☃, ☃)) * this.a.e);
    
    this.l.d = (☃ * 9.0F + ☃ * this.l.d);
    this.m.e = (☃ * 18.0F + ☃ * this.m.e);
    this.H.d = (☃ * 5.5F + ☃ * this.H.d);
    this.H.e = (☃ * 15.0F + ☃ * this.H.e);
    this.k.f = (☃ * -45.0F / 57.295776F + ☃ * this.k.f);
    ...
    this.g.f = this.a.f;
    this.h.f = this.a.f;
    this.b.f = (0.0F - 0.09424778F * ☃);
    this.c.f = (0.0F + 0.15707964F * ☃);
    ...
    this.v.d = (this.o.d + ns.a(1.5707964F + ☃ + ☃ * -☃ * 0.5F * ☃) * 7.0F);
    this.v.e = (this.o.e + ns.b(4.712389F + ☃ + ☃ * -☃ * 0.5F * ☃) * 7.0F);
    
    this.y.d = (this.x.d + ns.a(1.5707964F + ☃ + ☃ * ☃ * 0.5F * ☃) * 7.0F);
    this.y.e = (this.x.e + ns.b(4.712389F + ☃ + ☃ * ☃ * 0.5F * ☃) * 7.0F);
    
    float ☃ = (-1.0471976F + ☃) * ☃ + ☃ * ☃;
    float ☃ = (-1.0471976F + -☃) * ☃ + -☃ * ☃;
    this.B.d = (this.A.d + ns.a(1.5707964F + ☃) * 7.0F);
    this.B.e = (this.A.e + ns.b(4.712389F + ☃) * 7.0F);
    
    this.E.d = (this.D.d + ns.a(1.5707964F + ☃) * 7.0F);
    this.E.e = (this.D.e + ns.b(4.712389F + ☃) * 7.0F);
    
    this.o.f = (☃ + -☃ * 0.5F * ☃ * ☃);
    this.v.f = (-0.08726646F * ☃ + (-☃ * 0.5F * ☃ - Math.max(0.0F, ☃ * 0.5F * ☃)) * ☃);
    this.w.f = this.v.f;
    
    this.x.f = (☃ + ☃ * 0.5F * ☃ * ☃);
    this.y.f = (-0.08726646F * ☃ + (☃ * 0.5F * ☃ - Math.max(0.0F, -☃ * 0.5F * ☃)) * ☃);
    this.z.f = this.y.f;
    
    this.A.f = ☃;
    this.B.f = ((this.A.f + 3.1415927F * Math.max(0.0F, 0.2F + ☃ * 0.2F)) * ☃ + (☃ + Math.max(0.0F, ☃ * 0.5F * ☃)) * ☃);
    this.C.f = this.B.f;
    
    this.D.f = ☃;
    this.E.f = ((this.D.f + 3.1415927F * Math.max(0.0F, 0.2F - ☃ * 0.2F)) * ☃ + (-☃ + Math.max(0.0F, -☃ * 0.5F * ☃)) * ☃);
    this.F.f = this.E.f;
