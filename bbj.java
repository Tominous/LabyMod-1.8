  ...
  extends bbo
{
  ...
  public void a(pk entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale)
  {
    ...
    else
    {
      ...
      if (ModAPI.enabled()) {
        event = (RenderModelBipedEvent)ModAPI.callEvent(new RenderModelBipedEvent(this.e, this.f, this.g, this.h, this.i, this.j, this.k, scale, entityIn, p_78088_2_, p_78088_3_, p_78088_4_, p_78088_5_, p_78088_6_, this));
      }
      if ((event != null) && (event.getModifiedBipedHead() != null)) {
        this.e = event.getModifiedBipedHead();
      } else {
        this.e.a(scale);
      }
