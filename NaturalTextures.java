...
public class NaturalTextures
{
  ...
  {
    bmh terrainMap = TextureUtils.getTextureMapBlocks();
    bmi icon = terrainMap.getSpriteSafe("minecraft:blocks/" + iconName);
    if (icon == null)
    {
    ...
    if (!Config.isFromDefaultResourcePack(new jy("textures/blocks/" + iconName + ".png"))) {
      return;
    }
