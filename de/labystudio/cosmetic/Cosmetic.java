...
public class Cosmetic
{
  ...
  private void parseData()
  {
    if ((this.data != null) && (this.type != null) && 
      ((this.type == EnumCosmetic.WINGS) || (this.type == EnumCosmetic.HAT) || (this.type == EnumCosmetic.BLAZE)) && 
      ...
      try
      {
        ...
        if (d.length >= 3)
        {
          this.a = Float.parseFloat(d[0]);
          this.b = Float.parseFloat(d[1]);
          this.c = Float.parseFloat(d[2]);
        }
      }
