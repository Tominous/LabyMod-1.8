  ...
  extends axu
{
  ...
  public GuiLabyModMenu(axu lastScreen)
  {
  ...
  public void b()
  {
    ...
    this.n.clear();
    this.n.add(new avs(2, this.l - 115, this.m - 30 - 44, 110, 20, "Join our TeamSpeak"));
    this.n.add(new avs(0, this.l - 115, this.m - 30 - 22, 110, 20, "Open website"));
    this.n.add(new avs(1, this.l - 115, this.m - 30, 110, 20, "Close"));
  ...
  public void a(int mouseX, int mouseY, float partialTicks)
  {
    ...
    try
    {
      ...
      ArrayList<String> selectedLog = null;
