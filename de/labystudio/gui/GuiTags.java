  ...
  extends GuiMenuScreen
{
  ...
  public void b()
  {
    ...
    this.n.clear();
    this.n.add(this.btnAddFriend = new avs(0, this.l / 2 - 154, this.m - 26, 100, 20, L._("gui_tags_addfriend", new Object[0])));
    this.n.add(this.btnEditFriend = new avs(1, this.l / 2 - 50, this.m - 26, 100, 20, L._("gui_tags_editfriend", new Object[0])));
    this.n.add(this.btnDeleteFriend = new avs(2, this.l / 2 + 4 + 50, this.m - 26, 100, 20, L._("gui_tags_deletefriend", new Object[0])));
  ...
  private void initEditor(String name)
  {
    ...
    avs cancel = new avs(4, this.l / 2 - 100, this.m / 2 + 53, L._("button_cancel", new Object[0]));
    this.n.add(cancel);
