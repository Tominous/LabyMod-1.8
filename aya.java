  ...
  implements awx
{
  ...
  public aya()
  {
    ...
    if (!"".isEmpty())
    {
      this.x = ("You are using a " + Color.clc("e") + "" + Color.clc("f") + " version of the LabyMod!");
  ...
  public void b()
  {
    ...
    if ((calendar.get(2) + 1 == 12) && (calendar.get(5) == 24)) {
      ...
      this.r = "Happy birthday, Fleance!";
    } else if ((calendar.get(2) + 1 == 4) && (calendar.get(5) == 25)) {
      this.r = "Happy birthday, _qlow!";
  ...
  private void b(int p_73969_1_, int p_73969_2_)
  {
    ...
    catch (Exception error)
    {
      ...
      GuiCustomButton a = new GuiCustomButton(-1, this.l / 2 - 100, p_73969_1_ + p_73969_2_ * 2 - 45, Color.clc("4") + "An error occurred while loading the LabyMod!");
      a.noGui = true;
      this.n.add(a);
  ...
  public void a(int mouseX, int mouseY, float partialTicks)
  {
    ...
    c(this.q, "LabyMod 2.7.98 ", 2, this.m - 10, -1);
    c(this.q, s, 2, this.m - 20, -1);
    
    bfl.c(1.0F, 1.0F, 1.0F);
    
    String s1 = "Copyright Mojang AB. Do not distribute!";
    c(this.q, s1, this.l - this.q.a(s1) - 2, this.m - 10, -1);
    ...
    bfl.F();
    LabyMod.getInstance().draw.drawString(color + "@LabyMod", 15.0D, 2.0D, 1.0D);
    if ((LabyMod.getInstance().supportApply) && (getLocale() != null) && (getLocale().toString().equals("de_DE")))
    {
