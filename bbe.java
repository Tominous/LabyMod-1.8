  ...
  extends bbo
{
  ...
  public void a(float ☃, float ☃, float ☃, float ☃, float ☃, float ☃, pk ☃)
  {
    for (int ☃ = 0; ☃ < this.d.length; ☃++)
    {
      this.d[☃].g = (ns.b(☃ * 0.9F + ☃ * 0.15F * 3.1415927F) * 3.1415927F * 0.01F * (1 + Math.abs(☃ - 2)));
      this.d[☃].c = (ns.a(☃ * 0.9F + ☃ * 0.15F * 3.1415927F) * 3.1415927F * 0.1F * Math.abs(☃ - 2));
    }
  }
}
